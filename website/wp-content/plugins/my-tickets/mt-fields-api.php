...
add_filter( 'mt_custom_fields', 'parrain_custom_fields', 10, 2 );
function parrain_custom_fields( $array ) {
	// Other fields: sanitize callback; input type; input values; display_callback
	$array['parrain'] = array( 
		'title'=>"Quelle association vous a parlé de nous ?", 
		'sanitize_callback'=>'sanitize_callback', 
		'display_callback'=>'display_callback',
		'input_type'=>'select',
		'input_values'=>array('Aucune', 'Infox', 'ATC', 'Psycho', 'GEA', 'ADESI', 'GMP', 'Sages femmes', 'STAPS', 'Info Com', 'ASSED', 'Mesures physiques', 'IAE', 'CarpeDiem', 'CentraleSup'),
		'context'=> 'global'
	);
	return $array;
}
